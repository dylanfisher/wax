...
Shopify.addItem = function(variant_id, quantity, callback) {
  ...
  var params = {
    type: 'POST',
    url: 'http://store.readwax.com/cart/add.js',
...
Shopify.getCart = function(callback) {
  jQuery.getJSON('http://store.readwax.com/cart.js', function (cart, textStatus) {
    if ((typeof callback) === 'function') {
      callback(cart);
    }
    else {
...
Shopify.getCartShippingRatesForDestination = function(shipping_address, callback) {
  var params = {
    type: 'GET',
    url: 'http://store.readwax.com/cart/shipping_rates.json',
...
Shopify.getProduct = function(handle, callback) {
  jQuery.getJSON('http://store.readwax.com/products/' + handle + '.js', function (product, textStatus) {
    if ((typeof callback) === 'function') {
      callback(product);
    }
    else {
...
Shopify.changeItem = function(variant_id, quantity, callback) {
  var params = {
    type: 'POST',
    url: 'http://store.readwax.com/cart/change.js',
    data:  'quantity='+quantity+'&id='+variant_id,
    dataType: 'json',
...
Shopify.clear = function(callback) {
  var params = {
    type: 'POST',
    url: 'http://store.readwax.com/cart/clear.js',
    data:  '',
    dataType: 'json',
    success: function(cart) { 
      if ((typeof callback) === 'function') {
...
Shopify.updateCartFromForm = function(form_id, callback) {
  var params = {
    type: 'POST',
    url: 'http://store.readwax.com/cart/update.js',
    data: jQuery('#' + form_id).serialize(),
    dataType: 'json',
    success: function(cart) {
      if ((typeof callback) === 'function') {
